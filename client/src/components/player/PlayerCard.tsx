...
export function PlayerCard({ player, showTeam = true }: PlayerCardProps) {
  return (
    <Link
      ...
      className="flex items-center gap-3 md:gap-4 p-3 rounded-lg hover:bg-white/5 transition-colors min-h-[56px]"
    >
      {/* Avatar placeholder */}
      <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-slate-700 flex items-center justify-center text-slate-300 font-bold text-sm md:text-base flex-shrink-0">
