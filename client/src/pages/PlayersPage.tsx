        ...
        <CardContent className="py-3 md:py-4">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2">
              <span className="text-xs sm:text-sm text-slate-400">Position:</span>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      position === pos
                        ...
                        : 'bg-slate-700/50 text-slate-300 hover:bg-slate-700 border border-white/10 active:bg-slate-600'
                    )}
                  >
                    {pos}
                  </button>
          ...
          {isLoading ? (
            ...
            <>
              ...
              {data && data.pagination.pages > 1 && (
                <div className="px-3 md:px-4 py-3 md:py-4 border-t border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
