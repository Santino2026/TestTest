    ...
    >
          ...
          <div className="space-y-4 md:space-y-0 md:flex md:flex-wrap md:items-end md:gap-4">
            <div className="flex-1 min-w-0">
              ...
              <select
                ...
                className="w-full px-3 py-2.5 bg-white border border-slate-200 rounded-lg text-slate-900"
              >
              ...
              <div className="flex items-center justify-center gap-4 md:gap-8">
                <div className="text-center flex-1">
                  <TeamLogo
                    ...
                    size="sm"
                  />
                  <p className="font-medium mt-1 md:mt-2 text-sm md:text-base truncate">{getTeamById(lastResult.home_team_id)?.name}</p>
                  <p className={cn(
                    'text-2xl md:text-3xl font-bold',
                    lastResult.home_score > lastResult.away_score ? 'text-green-600' : 'text-slate-900'
                  )}>
                ...
                <div className="text-center flex-shrink-0">
                  ...
                  <Link
                    ...
                    className="block mt-2 text-xs md:text-sm text-blue-600 hover:underline"
                  >
                    Box Score
                  </Link>
                </div>
                ...
                <div className="text-center flex-1">
                  <TeamLogo
                    ...
                    size="sm"
                  />
                  <p className="font-medium mt-1 md:mt-2 text-sm md:text-base truncate">{getTeamById(lastResult.away_team_id)?.name}</p>
                  <p className={cn(
                    'text-2xl md:text-3xl font-bold',
                    lastResult.away_score > lastResult.home_score ? 'text-green-600' : 'text-slate-900'
                  )}>
      ...
      <Card>
        ...
        <CardContent className="p-0">
          {isLoading ? (
            <div className="p-8 text-center text-slate-500">Loading games...</div>
